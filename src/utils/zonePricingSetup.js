...
exports.ensureDefaultPlanZoneMappings = exports.upsertZonesAndCountries = void 0;
...
const upsertZonesAndCountries = async () => {
    ...
    const totalCountries = DEFAULT_ZONES.reduce((sum, zone) => sum + zone.countries.length, 0);
    return {
        zonesByName,
        createdZones,
        createdCountries,
...
exports.upsertZonesAndCountries = upsertZonesAndCountries;
const ensureDefaultPlanZoneMappings = async (zonesByName) => {
    ...
    if (!plans || !plans.length) {
        return { matchedPlans: [], createdMappings: 0, skippedPlans: planNames };
    }
...
exports.ensureDefaultPlanZoneMappings = ensureDefaultPlanZoneMappings;
//# sourceMappingURL=zonePricingSetup.js.map